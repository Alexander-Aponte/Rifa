...
<template>
  <div class="container-parallax container-app shadow">
    <div class="parallax">
...
.container-parallax {
  border-radius: 1rem;
  background-color: rgb(94, 86, 101);
  padding: 1rem;
...
.parallax-text-container-calendar-clock {
  display: flex;
  justify-content: center;
  width: 100%;
  margin-bottom: 1rem;
